 ...
 * Used by useAuth to distinguish "authenticated but not authorized to use the app"
 * from other failures. The backend returns 403 from /api/auth/self when the user
 * has no app roles assigned.
 */
