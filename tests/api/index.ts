...
export function createTestDataBundle(
  ...
  return {
    ...
    shoppingLists: {
      ...
      updateLine: shoppingListFactory.updateLine.bind(shoppingListFactory),
      createSellerGroup: shoppingListFactory.createSellerGroup.bind(shoppingListFactory),
      updateSellerGroup: shoppingListFactory.updateSellerGroup.bind(shoppingListFactory),
      orderSellerGroup: shoppingListFactory.orderSellerGroup.bind(shoppingListFactory),
      reopenSellerGroup: shoppingListFactory.reopenSellerGroup.bind(shoppingListFactory),
      deleteSellerGroup: shoppingListFactory.deleteSellerGroup.bind(shoppingListFactory),
      ...
      expectActiveMembership: shoppingListFactory.expectActiveMembership.bind(shoppingListFactory),
    },
    kits: {
